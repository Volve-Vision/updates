...
<picture>
  ...
  <img alt="Volve Vision product map: viewers, camera owners, venues and businesses served by the web platform, mobile apps, VolveMenu and video analytics, all on a shared foundation" src="assets/diagrams/product-map-light.svg">
</picture>
...
<picture>
  ...
  <img alt="Catalogue in numbers: 98 countries, around 1,000 city pages, around 5,000 published cameras, 4 languages, 22,000 or more published pages" src="assets/diagrams/catalogue-light.svg">
</picture>
...
<picture>
  ...
  <img alt="Timeline from the first generation of apps in 2022 through the platform rebuild starting December 2025 to the account security centre in September 2026" src="assets/diagrams/timeline-light.svg">
</picture>
...
<picture>
  ...
  <img alt="Roadmap in three columns: Now, Next and Later" src="assets/diagrams/roadmap-light.svg">
</picture>
